...
const testimonials: Testimonial[] = [
  {
    image: "/images/9b1764311761fff86a6a0fc0da2b83c8349b2232.png",
    name: "Sarah Johnson",
    location: "Austin, TX",
    rating: 5,
    quote:
      "The Aveyo team made going solar incredibly easy. From the initial consultation to the final installation, everything was seamless. Our energy bills have dropped by 70%!",
  },
  {
    ...
    rating: 5,
    quote:
      "I was skeptical at first, but Aveyo's transparency won me over. No hidden fees, exactly what they promised. Best home investment I've ever made.",
  },
  {
    ...
    rating: 5,
    quote:
      "Outstanding service from start to finish. The installation crew was professional and clean. It's been 6 months and my panels are performing above expectations.",
  },
];
          ...
          <div className="relative flex flex-col gap-5">
            <div className="flex items-center gap-4">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-1 text-[14px] leading-snug text-[color:var(--home-gray-dark-4)]">{testimonial.location}</p>
              </div>
            </div>
    ...
    >
      <div className="mx-auto mb-12 max-w-7xl px-4 sm:mb-16 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="text-[color:var(--home-gray-dark-4)]">See what our customers have to say about us</p>
        </div>
      </div>

      <div className="relative flex flex-col items-center">
        <p className="sr-only" aria-live="polite">
          Showing {visibleCount} testimonial card{visibleCount === 1 ? "" : "s"} in the main area, with part of the
