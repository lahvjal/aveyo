    ...
    <>
      <div className="customer-panel overflow-hidden mb-4 sm:mb-6">
        <div className="px-3 sm:px-4 py-4 sm:py-5">
          <h3 className="text-base sm:text-lg leading-6 font-medium text-[var(--customer-color-text-primary)]">Customer Support</h3>
          ...
          <div className="px-2 sm:px-3 md:px-4 py-4 sm:py-5 md:py-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
              ...
              <a 
                ...
                className="flex flex-col items-center justify-center rounded-[var(--customer-radius-card)] border border-[var(--customer-color-border)] p-3 sm:p-4 md:p-6 transition-colors hover:bg-[rgba(110,185,254,0.05)]"
              >
                <div className="rounded-full bg-[rgba(110,185,254,0.12)] p-1.5 sm:p-2 md:p-3 mb-2 sm:mb-3 md:mb-4">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 md:h-8 md:w-8 text-brand-blue" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                </div>
                <h3 className="text-sm sm:text-base md:text-lg font-medium text-[var(--customer-color-text-primary)]">Email Us</h3>
                <p className="mt-0.5 sm:mt-1 text-xs sm:text-sm text-[var(--customer-color-text-subtle)]">customercare@aveyo.com</p>
                <span className="brand-button mt-2 sm:mt-3 md:mt-4 inline-flex items-center px-4 py-2 text-xs font-medium">
                  Send Email
                </span>
              </a>
              ...
              >
                ...
                <h3 className="text-sm sm:text-base md:text-lg font-medium text-[var(--customer-color-text-primary)]">Call Us</h3>
                <p className="mt-0.5 sm:mt-1 text-xs sm:text-sm text-[var(--customer-color-text-subtle)]">(385) 469-3838</p>
                <span className="brand-button mt-2 sm:mt-3 md:mt-4 inline-flex items-center px-4 py-2 text-xs font-medium">
                  Call Now
                </span>
              </a>
