-- Add is_manager to get_profile_branch return type
-- The column was added in 008_add_manager_role.sql but the function was never updated,
-- so branchProfiles came back without is_manager, breaking manager-scoped dropdowns.
...
BEGIN
  ...
  WITH RECURSIVE branch AS (
    ...
    SELECT
      ...
      p.department_id, p.manager_id, p.social_links, p.is_admin, p.is_manager,
